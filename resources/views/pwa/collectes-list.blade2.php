...
<script type="module">
    ...
    async function chargerDonneesClient() {
        ...
        if (!activeDB) {
            console.error("Aucune base de données active trouvée.");
            return;
        }
    ...
    async function enregistrerModifCollecte() {
        ...
        try {
            ...
            const toutesCols = await activeDB.collectes.where('cycle_id').equals(col.cycle_id).toArray();
            ...
            await activeDB.cycles.update(col.cycle_id, { 
