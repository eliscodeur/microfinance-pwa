            ...
            <form method="POST"
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nom" class="form-control"
                            value="{{ isset($client) ? $client->nom : old('nom') }}" required>
                    </div>
                    <div class="col-md-6 ">
                        <label>Prénom du client</label>
                        <input type="text" name="prenom" class="form-control"
                            value="{{ isset($client) ? $client->prenom : old('prenom') }}" required>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="lieu_naissance" class="form-control"
                            value="{{ isset($client) ? $client->lieu_naissance : old('lieu_naissance') }}">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="nationalite" class="form-control"
                            value="{{ isset($client) ? $client->nationalite : old('nationalite') }}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label>Profession</label>
                        <input type="text" name="profession" class="form-control"
                            value="{{ isset($client) ? $client->profession : old('profession') }}">
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="image-upload-wrapper border-dashed text-center p-2 position-relative"
                        ...
                        <div id="uploadPlaceholder" class="p-3 {{ isset($client) && $client->photo ? 'd-none' : '' }}"
                ...
                <div class="p-3 mb-3 bg-light" style="border-radius: 10px; border: 1px solid #ddd;">
                    <h6 class="text-muted mb-3"><i class="bi bi-person-badge me-1"></i> Personne de référence (Urgence)
                    </h6>
                    <div class="row">
                        <div class="col-md-6">
                            <label>Nom complet du référent</label>
                            <input type="text" name="reference_nom" class="form-control"
                                value="{{ isset($client) ? $client->reference_nom : old('reference_nom') }}">
                        </div>
                        <div class="col-md-6">
