    ...
    <div class="sidebar" id="sidebarNav">
        <div class="sidebar-nav">
            ...
            @can('Gérer Utilisateurs')
                ...
                <div class="collapse {{ $usersMenuOpen ? 'show' : '' }} submenu" id="usersSub"
            ...
            @can('Gérer Agents')
                ...
                <div class="collapse {{ $agentsMenuOpen ? 'show' : '' }} submenu" id="agentsSub"
                    data-bs-parent="#sidebarNav">
            ...
            @can('Gérer Commissions')
                ...
                <div class="collapse {{ $bonusMenuOpen ? 'show' : '' }} submenu" id="commissionsSub"
                    ...
                    <a href="{{ route('admin.bonuses.index') }}"
                        class="{{ request()->routeIs('admin.bonuses.index') ? 'active' : '' }}">
                        <i class="bi bi-hourglass-split me-1 small"></i> À valider
                    </a>
                    <a href="{{ route('admin.bonuses.history') }}"
                        class="{{ request()->routeIs('admin.bonuses.history') ? 'active' : '' }}">
            ...
            @can('Valider Synchros')
                <a href="#collecteSub" data-bs-toggle="collapse"
                    aria-expanded="{{ $collecteMenuOpen ? 'true' : 'false' }}"
                ...
                <div class="collapse {{ $collecteMenuOpen ? 'show' : '' }} submenu" id="collecteSub"
                    ...
                    <a href="{{ route('admin.cycles.index') }}"
                        class="{{ request()->routeIs('admin.cycles.index') ? 'active' : '' }}">Cycles de collecte</a>
                </div>
            @endcan
