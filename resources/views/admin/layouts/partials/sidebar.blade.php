...
<div class="sidebar" id="sidebarNav">
    <div class="sidebar-nav">
        ...
        <div class="nav-section-title">Rémunération</div>
        ...
        <div class="collapse {{ $bonusMenuOpen ? 'show' : '' }} submenu" id="commissionsSub" data-bs-parent="#sidebarNav">
            <a href="{{ route('admin.bonuses.index') }}" class="{{ request()->routeIs('admin.bonuses.index') ? 'active' : '' }}">À valider</a>
            <a href="{{ route('admin.bonuses.history') }}" class="{{ request()->routeIs('admin.bonuses.history') ? 'active' : '' }}">Historique</a>
        </div>
        @endcan
        @can('Gérer Crédits')
