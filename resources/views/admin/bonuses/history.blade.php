...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="mb-0 fw-bold"><i class="bi bi-clock-history text-primary me-2"></i>Historique des bonus et des
                    commissions sur cycle</h2>
                        ...
                        <tbody>
                            @forelse($paiements as $p)
                                <tr>
                                    <td class="ps-4">
                                        <span
                                            class="badge bg-primary-subtle text-primary border border-primary-subtle px-2 py-1 mb-1">
                                            {{ $p->reference }}
                                        </span>
                                    ...
                                    <td>
                                        ...
                                        <div class="text-muted" style="font-size: 0.75rem;">{{ $p->agent->code_agent }}
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        ...
                                        <button type="button"
                                            ...
                                            data-ref="{{ $p->reference }}" data-agent="{{ $p->agent->nom }}"
                                            data-type="{{ $p->type }}" data-items='@json($p->bonuses)'>
                                            <span
            ...
            detailButtons.forEach(button => {
                button.addEventListener('click', function(e) {
                    ...
                    let tableRows = items.map(item => {
                        const dateAttrib = item.date_attribution ? new Date(item
                            .date_attribution).toLocaleDateString('fr-FR') : '-';
