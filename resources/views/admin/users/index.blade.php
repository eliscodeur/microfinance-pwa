...
@section('content')
    <div class="container-fluid">
        ...
        <ul class="nav nav-tabs mb-4" id="adminTabs" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link text-primary" id="add-tab" data-bs-toggle="tab" data-bs-target="#add-content"
                    type="button" role="tab">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0" id="adminsTable">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center py-5 text-muted">Aucun administrateur
                                            enregistré.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                    ...
                    <form action="{{ route('admin.users.store') }}" method="POST" id="admin-form">
                        ...
                        <div class="row" id="password-group">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="password" name="password_confirmation" id="field-password-conf"
                                    class="form-control">
                            </div>
                        </div>
        ...
        $(document).ready(function() {
            $('#adminsTable').DataTable({
                ...
                language: {
                    ...
                    info: "Affichage des admins _START_ à _END_ sur _TOTAL_ admins",
                    infoEmpty: "Affichage de 0 à 0 sur 0 admin",
