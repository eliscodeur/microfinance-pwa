        ...
        <div class="row g-4">
                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body text-center p-4">
                        <div class="mx-auto mb-3 d-flex align-items-center justify-content-center rounded-circle text-white fw-bold"
                            style="width: 84px; height: 84px; background: linear-gradient(135deg, #1f6feb, #0ea5e9); font-size: 2rem;">
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white fw-bold">Mettre à jour le profil</div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.profile.update') }}">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    <hr>
                                    <p class="text-muted small mb-0">Laissez les champs mot de passe vides si vous ne voulez
                                        pas le modifier.</p>
                                </div>
                                <div class="col-md-4">
