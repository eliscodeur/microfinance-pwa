                ...
                <div className="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <p className="text-muted mb-0">
                            Liste des demandes et suivi des encours crédits
                            clients.
                        </p>
                    </div>
                    <Link
                                    ...
                                    {credits.data.map((credit) => (
                                        <tr key={credit.id}>
                                            ...
                                            <td className="pe-4 text-end">
                                                <Link
                                                    href={`/admin/credits/${credit.credit_uid}`}
                ...
                {credits.links && credits.links.length > 3 && (
                    <div className="mt-4 d-flex justify-content-between align-items-center bg-white p-3 rounded shadow-sm">
                        <div className="text-muted small">
                            Affichage de {credits.from || 0} à {credits.to || 0}{" "}
                            sur {credits.total} demandes
                        </div>
                        <nav>
