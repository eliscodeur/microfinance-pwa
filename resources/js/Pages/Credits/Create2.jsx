                                ...
                                <fieldset className="mb-4">
                                    ...
                                    <div className="row g-3">
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            >
                                                {/* Cas 1 : Carnet Compte -> Uniquement Crédit sur compte */}
                                                {selectedCarnet?.type === 'compte' && (
                                                    <option value="compte">Crédit sur compte</option>
                                                )}

                                                {/* Cas 2 : Carnet Tontine -> Choix entre Quinzaine et Mensuel */}
                                                ...
                                                {/* Cas 3 : Rien n'est encore sélectionné -> On affiche tout */}
                                                {selectedCarnet?.type !== 'compte' && selectedCarnet?.type !== 'tontine' && (
                                                    <>
